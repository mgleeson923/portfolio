...
<head>
    ...
    <link rel="stylesheet" href="resources/font_icon/css/pe-icon-7-stroke.css">
    <link rel="stylesheet" href="resources/font_icon/css/helper.css">
...
<header id="header">
    <div class="center text-center">
        <h1 class="bigheadline">Michael Gleeson</h1>
...
<section id="navigation">
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
                <div class="logo"><a data-scroll href="#body" class="logo-text">Michael Gleeson</a></div>
            </div>
            <div class="col-xs-6">
                <div class="nav">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <ul>
                            ...
                            <li><a data-scroll href="#testimonial">Testimonials <i class="pe-7s-comment"></i><span class="menu-effect"></span></a></li>
...
<section id="services" class="service-area">
    <div class="container">
        <h2 class="block_title">Services: What can I do for you?</h2>
        <div class="row">
    ...
    <div class="container">
        ...
        <div class="row port cs-style-3">
            <div class="col-md-4 col-sm-6 col-xs-12 item-space">
                <figure>
                    <img src="resources/images/calendar.png" alt="img04">
                    <figcaption>
                        <h3>GC Prework #1</h3>
                        <span>Michael Gleeson</span>
                        <a href="https://github.com/mgleeson923/Deliverable_Project_1" class="button" >Take a look</a>
                    </figcaption>
                </figure>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12 item-space">
                <figure>
                    <img src="resources/images/armstrongnumber.png" alt="img01">
                    <figcaption>
                        <h3>GC Prework #2</h3>
                        <span>Michael Gleeson</span>
                        <a href="https://github.com/mgleeson923/Deliverable_2" class="button" >Take a look</a>
                    </figcaption>
                </figure>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12 item-space">
                <figure>
                    <img src="resources/images/posterminal.png" alt="img02">
                    <figcaption>
                        <h3>POS Terminal</h3>
                        <span>Michael Gleeson & Team</span>
                        <a href="https://github.com/mgleeson923/POSTerminalMidterm" class="button" >Take a look</a>
                    </figcaption>
                </figure>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12 item-space">
                <figure>
                    <img src="resources/images/roshambo.jpg" alt="img04">
                    <figcaption>
                        <h3>Roshambo Game</h3>
                        <span>Michael Gleeson</span>
                        <a href="https://github.com/mgleeson923/Lab12" class="button" >Take a look</a>
                    </figcaption>
                </figure>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12 item-space">
                <figure>
                    <img src="resources/images/xcode.jpg" alt="img01">
                    <figcaption>
                        <h3>Xcode Projects</h3>
                        <span>Michael Gleeson</span>
                        <a href="https://github.com/mgleeson923/X-Code-Projects" class="button" >Take a look</a>
                    </figcaption>
                </figure>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12 item-space">
                <figure>
                    <img src="resources/images/homepage.png" alt="img02">
                    <figcaption>
                        <h3>Grand Circus Buddy</h3>
                        <span>Michael Gleeson & Team</span>
                        <a href="https://github.com/fbaraka/GCBuddy" class="button" >Take a look</a>
                    </figcaption>
                </figure>
            </div>
            <div class="col-xs-12">
                <div class="btn-center"><a href="https://github.com/mgleeson923" class="big button">View all</a></div>
            </div>
        </div>
    </div><!-- container -->
</section><!-- portfolio -->
        ...
        <div class="row">
            ...
            <div id="testimonial-container" class="col-xs-12">
                <div class="testimonila-block">
                    <img src="resources/images/aaronboard.jpg" alt="clients" class="selfshot">
                    <p>Working with Michael on the final project was a major pleasure.
                        He always took initiative on things that needed to get done and had fun doing it. I could always rely on him to come in a good mood
                        which I feel helped me be more productive and cheerful as well. Given the chance, I would gladly work with Michael again.</p>
                    <strong>Aaron Board</strong>
                    <br>
                    <small>Classmate/GC Buddy Teammate</small>
                </div>
                <div class="testimonila-block">
...
<section id="contact" class="mapWrap">
    ...
    <div id="contact-area">
        <div class="container">
            <h2 class="block_title">My Contact Information</h2>
            <div class="row">
                <div class="col-xs-12">
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    ...
                    <form role="form" method="post">
                        ...
                        <button type="submit" class="btn medium">Let me know</button>
                    </form>
                </div>
            </div>
        </div><!-- container -->
            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul class="scoialinks">
                        ...
                        <li class="social-icons"><a class="linkedin" href="https://www.linkedin.com/in/gleesonmichael/"></a></li>
                        <li class="social-icons"><a class="twitter" href="https://twitter.com/MichaelWGleeson"></a></li>
...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <p class="copyright">© Copyright 2017 <a href="#" target="_blank">michaelgleeson.com</a></p>
            </div>
            <div class="col-sm-6">
